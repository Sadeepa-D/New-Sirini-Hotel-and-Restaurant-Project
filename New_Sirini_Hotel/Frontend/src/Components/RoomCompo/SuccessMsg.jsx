      ...
      <div className="relative w-full max-w-sm bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in slide-in-from-bottom-8 duration-500">
        ...
        <div className="px-6 py-6 text-center">
          <div className="mb-4">
            ...
            <h2 className="text-white text-xl font-serif italic tracking-tight mb-1">Reservation Received</h2>
            <p className="text-gray-500 text-[10px] uppercase tracking-[0.15em] font-medium">Thank you for choosing New Sirini</p>
          </div>
          ...
          <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-3.5 mb-4 group hover:border-orange-500/20 transition-all duration-500">
            <div className="flex items-center gap-3 text-left">
              ...
              <div className="min-w-0 flex-1">
                <h4 className="text-white text-xs font-semibold truncate leading-none mb-1.5">{selectedRoom.roomType} Suite</h4>
                <div className="flex flex-wrap gap-x-3 gap-y-1">
                  <div className="flex items-center gap-1 text-gray-500 text-[9px] font-bold uppercase tracking-wider">
                    <Home size={10} className="text-orange-500" /> No: {selectedRoom.roomNumber}
                  </div>
                  <div className="flex items-center gap-1 text-gray-500 text-[9px] font-bold uppercase tracking-wider">
                    <Users size={10} className="text-orange-500" /> {selectedRoom.capacity} Guests
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-3 pt-3 border-t border-white/5 flex justify-between items-center">
              <span className="text-[9px] font-black uppercase text-gray-600 tracking-widest">Total Amount</span>
          ...
          <div className="bg-orange-500/5 border border-orange-500/10 rounded-xl p-3 mb-4 flex gap-3 items-start text-left">
            ...
            <div>
              <p className="text-orange-400 text-[9px] font-black uppercase tracking-widest mb-0.5">Status: Under Review</p>
