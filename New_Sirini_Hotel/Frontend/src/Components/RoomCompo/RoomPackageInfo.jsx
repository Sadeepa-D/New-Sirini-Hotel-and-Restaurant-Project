...
const RoomPackageInfo = () => {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-orange-100 mb-10 mt-4 relative overflow-hidden group hover:shadow-md transition-all duration-300">
      ...
      <div className="flex items-center gap-3 mb-6 relative z-10">
        ...
        <div>
          <h2 className="text-xl font-serif italic text-gray-900 tracking-tight">Our Packages</h2>
          <p className="text-[10px] text-gray-400 uppercase tracking-widest font-bold mt-0.5">Available booking options</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
        ...
        <div className="flex items-start gap-4 p-5 rounded-[1.25rem] bg-gradient-to-br from-orange-50/50 to-white border border-orange-100/60 hover:border-orange-200 hover:shadow-sm transition-all duration-300">
          ...
          <div className="flex-1">
            <h3 className="text-base font-bold text-gray-900 mb-1">Short Stay</h3>
            ...
            <div className="flex items-center gap-2 text-orange-600 bg-orange-100/50 w-fit px-3 py-1.5 rounded-lg border border-orange-100/50">
              <Clock size={14} />
              <span className="text-xs font-bold tracking-wide">12:00 PM - 3:00 PM</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 p-5 rounded-[1.25rem] bg-gradient-to-br from-blue-50/50 to-white border border-blue-100/60 hover:border-blue-200 hover:shadow-sm transition-all duration-300">
          ...
          <div className="flex-1">
            <h3 className="text-base font-bold text-gray-900 mb-1">Overnight Stay</h3>
            <p className="text-xs text-gray-500 mb-3 leading-relaxed">
            ...
            <div className="flex items-center gap-2 text-blue-600 bg-blue-100/50 w-fit px-3 py-1.5 rounded-lg border border-blue-100/50">
              <Clock size={14} />
              <span className="text-xs font-bold tracking-wide">4:00 PM - 10:00 AM <span className="text-[10px] uppercase opacity-80 ml-1">Next Day</span></span>
            </div>
          </div>
        </div>
      </div>
